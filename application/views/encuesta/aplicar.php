            ...
            <?php if($pregunta['idtipopregunta'] == PREGUNTA_OPCIONMULTIPLE){ ?>
              ...
              <?php foreach ($pregunta['array_complemento'] as $key => $complemento) { ?>
                ...
                <label class='checkbox-inline'>
                  <input class='<?=($pregunta['npregunta']==29)?'':'requerido'?> checkbox_change' type='checkbox' data-idpregunta="<?= $pregunta['idpregunta'] ?>" name="<?= $pregunta['idpregunta'] ?>" value='<?= $complemento['complemento'] ?>'> <?= $complemento['complemento'] ?>
                </label>
